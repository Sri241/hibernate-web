...
ans1.setPostedBy("Srilakshmi");    
    
Answer ans2=new Answer();    
ans2.setAnswername("Hibernate implements JPA.");    
ans2.setPostedBy("Lakshmi");    
    
Answer ans3=new Answer();    
ans3.setAnswername("Angular is used to create single page application.");    
ans3.setPostedBy("Anusha");    
    
Answer ans4=new Answer();    
ans4.setAnswername("Angular is a platform to built mobile and desktop web applications");    
ans4.setPostedBy("Subbu");    
